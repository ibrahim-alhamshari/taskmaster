...
public final class Team implements Model {
  ...
  private final @ModelField(targetType="GeneratedTaskModel") @HasMany(associatedWith = "team", type = GeneratedTaskModel.class) List<GeneratedTaskModel> tasks = null;
  ...
  public List<GeneratedTaskModel> getTasks() {
      return tasks;
  }
